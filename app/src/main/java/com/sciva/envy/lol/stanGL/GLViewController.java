...
//        onPrepareView(smartGLView);
    ...
    void putSpaceCruiser(Context context) {
        dropAllObject3D();
        WavefrontModel model = new WavefrontModel.Builder(context, R.raw.plan_test)
    ...
    void putSchoolPlan(Context context) {
        dropAllObject3D();
        WavefrontModel modelColored = new WavefrontModel.Builder(context, R.raw.plan_test_obj)
                .create();
